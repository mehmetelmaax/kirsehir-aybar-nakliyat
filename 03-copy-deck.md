...
- **Direct Phone Link**: `+90 537 312 34 47` (Wrapped in `tel:` link)
- **Trust Strip**: [ K3 Yetki Belgeli · 20 Yıllık Kırşehir Firması · Sabit Fiyat Garantisi ]

### SLIDE 1: Primary Value Proposition + Money Keyword (H1)
- **Headline**: Kırşehir Evden Eve Nakliyatta Sabit Fiyat
...
- **Visual Direction**: A close-up shot of a modern, clean moving truck with the "Aybar Evden Eve" branding, parked on an Kırşehir street. Natural sunlight, clean focus. No generic graphics.
- **Turkish Alt Text**: Kırşehir Aybar Nakliyat asansörlü ev taşıma aracı sokakta park halinde.
- **Slide-level Trust Line**: Sözleşmeli ve sigortalı taşımacılık yapıyoruz.

### SLIDE 2: Geographic & Route Authority (H2)
- **Headline**: Merkez ve Kaman’da Asansörlü Taşıma
- **Line Break Specification (at 380px)**:
  `Merkez ve Kaman’da`
  `Asansörlü Taşıma`
- **Subheadline**: Kırşehir'in tüm ilçelerinde yüksek katlı binalara kendi mobil eşya asansörlerimizle ulaşıyoruz.
- **Visual Direction**: An exterior view of a modern high-rise building in Kaman district. A red-and-white metal ladder elevator is extended up to a 10th-floor balcony, carrying padded furniture packages.
- **Turkish Alt Text**: Merkez'da asansörlü nakliyat aracı eşyaları yüksek kata çıkarıyor.
...
- **Turkish Alt Text**: Aybar Nakliyat marangoz personeli yatak odasında dolap kurulumu yapıyor.
...
- **Label**: Kırşehir Yerel Tecrübesi
- **Support Line**: 2006 yılından beri Merkez merkezli olarak Kırşehir genelinde hizmet veriyoruz.
...
"Aybar Nakliyat ile Merkez'dan Kaman'ya taşındık. Taşıma günü dedikleri saatte geldiler. Gardırobu söküp yeni evde aynen kurdular. Fiyat başta ne konuştursak o oldu, ekstra masraf çıkmadı. Teşekkürler."
- [Mehmet K., Merkez → Kaman]
```
...
- **Outcome Line**: Kırşehir'den Türkiye'nin tüm illerine sigortalı ve zamanında teslimat.
- **Mechanics**:
...
- **Outcome Line**: Kırşehir merkez ilçeleri arasında aynı gün içinde sorunsuz ev teslimi.
- **Mechanics**:
...
- **Best For**: İş kesintisi yaşamak istemeyen Kırşehir esnafı ve şirketleri.
...
- **A4**: Mobil asansörlü araçlarımız kamyonet boyutlarındadır ve standart Kırşehir sokaklarına rahatça giriş yapabilir. Sadece çok dar sokaklarda park önlemi alınması gerekir. Taşıma öncesi ekiplerimiz sokağın durumunu inceler.
...
> *"Aybar Nakliyat olarak taşıdığımız mobilyalarda oluşabilecek darbe veya kırılmaları marangoz ekibimizle yerinde onarır, onarılamayacak hasarları nakit olarak karşılarız."*
...
- **CTAs**: Large button `[Teklif Al]` (Orange background, Navy label) and phone link `0537 312 34 47` highlighted.
