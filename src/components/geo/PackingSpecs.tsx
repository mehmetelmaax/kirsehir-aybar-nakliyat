  ...
  return (
    <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-6 text-charcoal">
      ...
      <p className="text-xs md:text-sm leading-relaxed">
        Kırşehir Aybar Nakliyat eşya paketleme işlemlerinde kullanılan koruyucu materyaller, yol hasarlarını sıfıra indirmek için özel üretilmiş katmanlı yapılardan oluşur. Eşyaların taşınması ve istiflenmesi sırasında darbe ve çizikleri engellemek için kullanılan standart malzemeler şunlardır:
      </p>

      <div className="overflow-x-auto">
        <table className="w-full text-left border-collapse text-xs md:text-sm">
          <caption>Aybar Nakliyat Koruyucu Paketleme Malzemeleri Kataloğu</caption>
          <thead>
