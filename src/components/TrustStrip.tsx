      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="flex gap-4 items-start p-4 hover:bg-gray-light/30 rounded-lg transition-colors">
            ...
            <div>
              <div className="font-display font-black text-navy text-2xl md:text-3xl">{new Date().getFullYear() - FACTS.foundedYear} Yıl</div>
              <div className="text-orange-text font-bold text-xs uppercase tracking-wider mt-1">Kırşehir Yerel Tecrübesi</div>
              <p className="text-charcoal text-sm leading-relaxed mt-2">
                {FACTS.foundedYear} yılından beri Merkez merkezli olarak Kırşehir&apos;in tüm bölgelerinde güvenli taşıma yapıyoruz.
              </p>
            </div>
          </div>
