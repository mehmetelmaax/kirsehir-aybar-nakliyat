...
export const metadata: Metadata = {
  title: 'Kırşehir Şehirlerarası Ev Taşıma',
      ...
      <main id="main" className="pt-24 bg-off-white">
        ...
        <section className="py-20 bg-navy text-white text-center space-y-4">
          ...
          <p className="text-gray-300 text-sm md:text-base max-w-xl mx-auto leading-relaxed">
            Kırşehir'den 81 ile emtia nakliyat sigortalı ve marangoz montaj dahil yasal şehirlerarası eşya taşımacılığı.
          </p>
        </section>
        ...
        <section className="py-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="bg-brand-accent/5 p-6 rounded-xl border-l-4 border-brand-accent space-y-2 shadow-sm">
            ...
            <p className="text-brand-dark text-sm leading-relaxed font-semibold">
              "Kırşehir şehirlerarası evden eve nakliyat, Kırşehir'den Türkiye'nin 81 iline çift şoförlü kamyonlar ve Anadolu Sigorta güvencesiyle yapılan uzun yol taşımacılığıdır. Kırşehir Aybar Nakliyat, şehirler arası nakliyatta K3 belgeli araçlarla sözleşmeli çalışır."
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-4">
            ...
            <p className="text-charcoal text-sm md:text-base leading-relaxed">
              Kırşehir Aybar Nakliyat şehirlerarası ev taşıma hizmetlerinde, eşyalarınızın tamamı {FACTS.insurer} emtia nakliyat sigortasıyla yangın, kaza ve doğal afet hasarlarına karşı güvence altına alınmaktadır. Emtia nakliyat sigortası, eşyaların taşıma esnasında karşılaşabileceği kaza, yangın ve hırsızlık gibi riskleri yasal teminat altına alan poliçe türüdür. Bu sigorta poliçesi, kamyonun seyir halindeyken karşılaşabileceği fiziksel hasarları yasal olarak tazmin eder.
            </p>
          ...
          <div id="rotalar" className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-6">
            ...
            <p className="text-charcoal text-sm md:text-base leading-relaxed">
              Kırşehir Aybar Nakliyat merkezli olarak Türkiye genelinde en çok sefer düzenlediğimiz popüler şehirlerarası 81 il nakliyat hatlarımızı aşağıda bulabilirsiniz. İlgili bağlantılara tıklayarak rota detayları, kilometre mesafeleri, sürüş süreleri ve güncel fiyat listelerine erişebilirsiniz:
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <Link href="/rotalar/kirsehir-istanbul-evden-eve-nakliyat" className="bg-off-white hover:bg-orange/10 p-4 rounded-lg border border-gray-light/60 font-bold text-navy text-sm flex justify-between items-center transition-colors group">
                <span>Kırşehir - İstanbul Nakliyat</span>
                <ArrowRight className="w-4 h-4 text-orange transition-transform group-hover:translate-x-1" />
              </Link>
              <Link href="/rotalar/kirsehir-ankara-evden-eve-nakliyat" className="bg-off-white hover:bg-orange/10 p-4 rounded-lg border border-gray-light/60 font-bold text-navy text-sm flex justify-between items-center transition-colors group">
                <span>Kırşehir - Ankara Nakliyat</span>
                <ArrowRight className="w-4 h-4 text-orange transition-transform group-hover:translate-x-1" />
              </Link>
              <Link href="/rotalar/kirsehir-mersin-evden-eve-nakliyat" className="bg-off-white hover:bg-orange/10 p-4 rounded-lg border border-gray-light/60 font-bold text-navy text-sm flex justify-between items-center transition-colors group">
                <span>Kırşehir - Mersin Nakliyat</span>
                <ArrowRight className="w-4 h-4 text-orange transition-transform group-hover:translate-x-1" />
              </Link>
              <Link href="/rotalar/kirsehir-gaziantep-evden-eve-nakliyat" className="bg-off-white hover:bg-orange/10 p-4 rounded-lg border border-gray-light/60 font-bold text-navy text-sm flex justify-between items-center transition-colors group">
                <span>Kırşehir - Gaziantep Nakliyat</span>
                <ArrowRight className="w-4 h-4 text-orange transition-transform group-hover:translate-x-1" />
              </Link>
              <Link href="/rotalar/kirsehir-izmir-evden-eve-nakliyat" className="bg-off-white hover:bg-orange/10 p-4 rounded-lg border border-gray-light/60 font-bold text-navy text-sm flex justify-between items-center transition-colors group">
                <span>Kırşehir - İzmir Nakliyat</span>
                <ArrowRight className="w-4 h-4 text-orange transition-transform group-hover:translate-x-1" />
              </Link>
              <Link href="/rotalar/kirsehir-antalya-evden-eve-nakliyat" className="bg-off-white hover:bg-orange/10 p-4 rounded-lg border border-gray-light/60 font-bold text-navy text-sm flex justify-between items-center transition-colors group">
                <span>Kırşehir - Antalya Nakliyat</span>
                <ArrowRight className="w-4 h-4 text-orange transition-transform group-hover:translate-x-1" />
              </Link>
              <Link href="/rotalar/kirsehir-kayseri-evden-eve-nakliyat" className="bg-off-white hover:bg-orange/10 p-4 rounded-lg border border-gray-light/60 font-bold text-navy text-sm flex justify-between items-center transition-colors group">
                <span>Kırşehir - Kayseri Nakliyat</span>
                <ArrowRight className="w-4 h-4 text-orange transition-transform group-hover:translate-x-1" />
              </Link>
              <Link href="/rotalar/kirsehir-bursa-evden-eve-nakliyat" className="bg-off-white hover:bg-orange/10 p-4 rounded-lg border border-gray-light/60 font-bold text-navy text-sm flex justify-between items-center transition-colors group">
                <span>Kırşehir - Bursa Nakliyat</span>
                <ArrowRight className="w-4 h-4 text-orange transition-transform group-hover:translate-x-1" />
              </Link>
            </div>
          </div>
