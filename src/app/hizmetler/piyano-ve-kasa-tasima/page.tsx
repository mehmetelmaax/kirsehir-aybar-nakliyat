...
export default function PiyanoVeKasaTasimaPage() {
  const piyanoFaqs = [
    ...
    },
    {
      ...
      answer: 'Evet. Aybar Nakliyat bünyesinde taşıdığımız her değerli ve ağır enstrüman/kasayı, taşınma öncesinde eşyanın net beyan edilen güncel piyasa değerine göre özel emtia sigortası kapsamına alarak yola çıkarıyoruz.'
    },
    {
  ...
  const schemas = {
    ...
    '@graph': [
      serviceSchema({
        name: 'Kırşehir Piyano ve Kasa Taşıma',
        description: "Kırşehir'de kuyruklu/duvar piyanosu, çelik para kasası ve hassas ağır yük taşımacılığı. Özel liftli araçlar ve askı sistemleriyle hasarsız transfer.",
      ...
      <main id="main" className="pt-24 bg-off-white min-h-screen">
        ...
        <section className="py-20 bg-navy text-white text-center space-y-4">
          ...
          <h1 className="font-display font-black text-3xl md:text-5xl tracking-tight leading-tight px-4">
            Kırşehir Piyano ve Kasa Taşıma
          </h1>
        ...
        <section className="py-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="bg-brand-accent/5 p-6 rounded-xl border-l-4 border-brand-accent space-y-2 shadow-sm">
            ...
            <p className="text-brand-dark text-sm leading-relaxed font-semibold">
              "Kırşehir'de piyano ve ağır kasa taşımacılığı, özel askı sistemleri, kızaklı taşıma aparatları ve liftli kamyonlarla yapılan hassas lojistik hizmettir. Kırşehir Aybar Nakliyat, bu hassas eşyaları çizilme ve hasar riskine karşı tamamen sigortalı taşır."
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-6">
            ...
            <p className="text-charcoal text-sm md:text-base leading-relaxed">
              Özel eğitimli Kırşehir Aybar Nakliyat ekipleri ve teknik donanımımızla taşımasını gerçekleştirdiğimiz değerli ve ağır eşya grupları şunlardır:
            </p>
