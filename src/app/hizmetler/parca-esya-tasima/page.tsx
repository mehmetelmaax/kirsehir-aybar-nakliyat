...
export default function ParcaEsyaTasimaPage() {
  const parcaFaqs = [
    ...
    },
    {
      ...
      answer: 'Evet. Kırşehir merkezli Merkez garajımızdan Ankara, İstanbul, İzmir, Bursa ve diğer tüm şehirlere düzenli olarak sefer yapan parsiyel taşıma tırlarımızla, tekil eşyalarınızı çok uygun ve avantajlı maliyetlerle adrese teslim gönderiyoruz.'
    },
    {
  ...
  const schemas = {
    ...
    '@graph': [
      serviceSchema({
        name: 'Kırşehir Parça Eşya Taşıma',
        description: "Kırşehir'de tek parça, az eşya veya öğrenci evi taşımacılığı. Uygun fiyatlı parça eşya nakliye tır ve kamyonetlerimizle hızlı taşıma hizmeti.",
        ...
        <section className="py-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="bg-brand-accent/5 p-6 rounded-xl border-l-4 border-brand-accent space-y-2 shadow-sm">
            ...
            <p className="text-brand-dark text-sm leading-relaxed font-semibold">
              "Kırşehir'de parça eşya taşıma, tek parça beyaz eşya, öğrenci evi veya az miktarda mobilyanın ekonomik şekilde nakledilmesidir. Kırşehir Aybar Nakliyat, parça eşya sevkiyatlarını K3 belgeli araçları ve uygun fiyatlarla aynı gün gerçekleştirebilir."
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-6">
            ...
            <p className="text-charcoal text-sm md:text-base leading-relaxed">
              Firmamız, Kırşehir Merkez ve Kaman başta olmak üzere her türlü kısmi eşya taşıma ihtiyacınıza özel araç ve ekip sağlamaktadır. En sık hizmet verdiğimiz senaryolar şunlardır:
            </p>
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-4">
            ...
            <p className="text-charcoal text-sm md:text-base leading-relaxed">Kırşehir Aybar Nakliyat, Kırşehir'den Türkiye'nin diğer illerine az sayıda eşya göndermek istediğinizde parsiyel taşımacılık hizmetimiz devreye girer. Haftalık olarak İstanbul, Ankara, İzmir, Bursa, Antalya gibi büyükşehirlere sefer düzenleyen geniş hacimli nakliyat tırlarımız, aynı güzergah üzerindeki parça eşyaları belirli bir plan çerçevesinde toplar. Eşyalarınız kasada diğer müşterilerin eşyalarıyla karışmaması için ara bölmelerle ayrılır ve teslimat sırasında listeye göre teker teker indirilerek yerinde kurulumu yapılır. Bu sayede tüm yol masrafları (yakıt, köprü geçişleri) bölündüğü için nakliye ücretiniz yarı yarıya düşmektedir.</p>
          </div>

          {/* Section 6: Kamyonet Kiralama vs Aybar Nakliyat */}
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-4">
            <h2 className="font-display font-bold text-navy text-xl md:text-2xl flex items-center gap-2">
              <Scale className="w-6 h-6 text-orange" />
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-4">
            ...
            <p className="text-charcoal text-sm md:text-base leading-relaxed">
              Az miktarda eşya taşınsa dahi yolda oluşabilecek kaza, devrilme veya yangın gibi risklere karşı güvence altında olmanız gerekir. Aybar Nakliyat olarak, parça eşya taşıma işlemlerimizin tamamında nakliye sigortasını standart olarak yapmaktayız. Taşınma öncesinde eşyanızın cinsi ve tahmini piyasa değeri tespit edilerek poliçeye işlenir. Yolculuk esnasında meydana gelebilecek hasarlar sigorta acentemiz tarafından karşılanır. Güvenliğiniz ve memnuniyetiniz bizim için her zaman ön plandadır.
            </p>
          </div>
          ...
          <div className="bg-navy/5 border border-navy/10 rounded-xl p-6 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
              ...
              <Link href="/bolgeler/kirsehir-merkez-evden-eve-nakliyat" className="text-orange-text hover:underline font-bold">
                → Merkez Bölgesi Nakliye Çözümleri
              </Link>
              <Link href="/bolgeler/kaman-evden-eve-nakliyat" className="text-orange-text hover:underline font-bold">
                → Kaman Bölgesi Nakliye Çözümleri
              </Link>
