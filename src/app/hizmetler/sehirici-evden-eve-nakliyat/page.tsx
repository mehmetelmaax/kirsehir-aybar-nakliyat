...
export const metadata: Metadata = {
  title: 'Kırşehir Şehir İçi Ev Taşıma',
  description: "Kırşehir merkez ilçelerinde aynı gün içinde asansörlü, sigortalı ve marangoz montaj dahil şehir içi evden eve nakliyat hizmeti. Hemen sabit fiyat alın.",
  alternates: {
...
export default function SehiriciPage() {
  ...
  },
  {
    ...
    "answer": "Evet. Taşıma öncesinde hazırlanan resmi nakliyat sözleşmesi gereği, taşınma sırasında oluşabilecek hasarlar Kırşehir Aybar Nakliyat yasal sorumluluğundadır."
  },
  {
      ...
      <main id="main" className="pt-24 bg-off-white">
        ...
        <section className="py-20 bg-navy text-white text-center space-y-4">
          ...
          <p className="text-gray-300 text-sm md:text-base max-w-xl mx-auto leading-relaxed">
            Merkez, Kaman, Mucur ve Çiçekdağı başta olmak üzere Kırşehir içi sorunsuz ev taşıma çözümleri.
          </p>
        </section>
        ...
        <section className="py-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="bg-brand-accent/5 p-6 rounded-xl border-l-4 border-brand-accent space-y-2 shadow-sm">
            ...
            <p className="text-brand-dark text-sm leading-relaxed font-semibold">
              "Kırşehir şehiriçi evden eve nakliyat, Merkez, Kaman ve Mucur ilçeleri arasında aynı gün asansörlü ve marangozlu ev taşıma sürecidir. Kırşehir Aybar Nakliyat, şehiriçi taşınmalarda gün içinde ek ücret çıkarmayan sabit fiyat garantisi sunmaktadır."
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-4">
            <h2 className="font-display font-bold text-navy text-xl md:text-2xl">
              Merkez ve Kaman Arası Taşıma Fiyatı Nasıl Belirlenir?
            </h2>
            <p className="text-charcoal text-sm md:text-base leading-relaxed">
              Merkez ve Kaman arasındaki 1 ev taşıma fiyatı, dairenizin oda sayısına, binaların kat yüksekliklerine ve asansör kurulum durumlarına göre belirlenmektedir. Kat yüksekliği arttıkça işçilik ve dış cephe asansör kurulum maliyeti toplam fiyata yansıtılır.
            </p>
