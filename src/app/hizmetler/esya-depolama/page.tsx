...
export const metadata: Metadata = {
  title: 'Kırşehir Eşya Depolama Hizmeti',
...
export default function EsyaDepolamaPage() {
  ...
  const schemas = {
    ...
    '@graph': [
      serviceSchema({
        name: 'Kırşehir Eşya Depolama Hizmeti',
        description: "Kırşehir'de aylık kiralık eşya depolama çözümleri. Güvenlik kameralı, rutubetsiz ve sigortalı konteyner depolarımızda eşyalarınızı güvenle saklayın.",
      ...
      <main id="main" className="pt-24 bg-off-white min-h-screen">
        ...
        <section className="py-20 bg-navy text-white text-center space-y-4">
          ...
          <h1 className="font-display font-black text-3xl md:text-5xl tracking-tight leading-tight px-4">
            Kırşehir Eşya Depolama Hizmeti
          </h1>
          <p className="text-gray-300 text-sm md:text-base max-w-2xl mx-auto leading-relaxed px-4">
            Ev veya iş yeri eşyalarınızı, Kırşehir Merkez merkezli güvenlik kameralı, rutubetsiz, sigortalı ve kişiye özel kiralık konteyner depolarımızda güvenle saklıyoruz.
          </p>
        </section>
        ...
        <section className="py-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="bg-brand-accent/5 p-6 rounded-xl border-l-4 border-brand-accent space-y-2 shadow-sm">
            ...
            <p className="text-brand-dark text-sm leading-relaxed font-semibold">
              "Kırşehir'de eşya depolama, fazla veya mevsimlik ev eşyalarınızın güvenlik kameralı, rutubetsiz ve Anadolu Sigorta güvenceli odalarımızda saklanması hizmetidir. Kırşehir Aybar Nakliyat, aylık kiralık depolama hizmetini uygun fiyatlarla sunar."
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-6">
            ...
            <p className="text-charcoal text-sm md:text-base leading-relaxed">
              Kırşehir Aybar Nakliyat kiralık depo ücretleri, eşyaların toplam hacmine göre mini, orta ve büyük boy konteyner hacimlerine bölünerek fiyatlandırılır. Tesislerimizde yer alan standart konteyner depo seçenekleri ve kapasiteleri şu şekildedir:
            </p>
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-6">
            ...
            <p className="text-charcoal text-sm md:text-base leading-relaxed">
              Kırşehir Aybar Nakliyat barkodlu depo yönetim sistemi sayesinde, giriş ve çıkış işlemlerinde her aşama yasal tutanaklarla belgelenmektedir. Eşyaların eksiksiz ve güvenle depolanması için giriş ve çıkış işlemlerinde şu yasal adımları uyguluyoruz:
            </p>
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-4">
            ...
            <p className="text-charcoal text-sm md:text-base leading-relaxed">
              Kırşehir Aybar Nakliyat depolarında saklanması yasak olan maddeler, kimyasal ve yanıcı materyallerin yol açabileceği yangın riskini önlemek için sıkı kurallara tabidir. Tüm müşterilerimizin eşyalarının güvenliğini ve hijyenini en üst seviyede tutmak adına depolarımızda bazı maddelerin saklanması kesinlikle yasaktır: akaryakıt, tiner, boya, tüp, bozulabilir gıdalar ve yasal ruhsatı bulunmayan tüm patlayıcı ve tehlikeli emtialar bu yasak kapsamındadır.
            </p>
          </div>
          ...
          <div className="bg-navy/5 border border-navy/10 rounded-xl p-6 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
              <Link href="/kirsehir-nakliyat-fiyatlari" className="text-orange-text hover:underline font-bold">
