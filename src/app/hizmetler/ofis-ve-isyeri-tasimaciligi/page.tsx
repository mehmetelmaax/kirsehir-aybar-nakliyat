        ...
        <section className="py-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="bg-brand-accent/5 p-6 rounded-xl border-l-4 border-brand-accent space-y-2 shadow-sm">
            ...
            <p className="text-brand-dark text-sm leading-relaxed font-semibold">
              "Kırşehir kurumsal ofis ve işyeri taşımacılığı, şirket arşivlerinin, mobilyalarının ve bilgisayarlarının numaralı kutularla sıfır kayıp garantili taşınmasıdır. Kırşehir Aybar Nakliyat, iş kaybı yaşamamanız için hafta sonu ekspres nakliye desteği verir."
            </p>
          </div>
