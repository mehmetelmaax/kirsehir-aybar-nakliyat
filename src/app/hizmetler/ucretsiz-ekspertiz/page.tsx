...
export const metadata: Metadata = {
  title: 'Ücretsiz Ekspertiz Hizmeti',
...
export default function EkspertizPage() {
  const sss = [
  {
    ...
    "answer": "Hayır. Kırşehir genelinde gerçekleştirdiğimiz tüm yerinde ve dijital görüntülü ekspertiz incelemeleri tamamen ücretsizdir."
  },
  {
  ...
  const schemas = {
    ...
    '@graph': [
      serviceSchema({
        ...
        description: "Kırşehir'de taşınma öncesinde eşya hacmini, bina kat durumunu ve asansör kurulum açısını yerinde veya görüntülü inceleyerek sabit fiyat teklifi çıkarma süreci.",
        ...
        <section className="py-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="bg-brand-accent/5 p-6 rounded-xl border-l-4 border-brand-accent space-y-2 shadow-sm">
            ...
            <p className="text-brand-dark text-sm leading-relaxed font-semibold">
              "Kırşehir ücretsiz nakliyat ekspertizi, taşınma günü ek ücret çıkmasını önlemek için eşya hacminin, katların ve asansör kurulum açısının yerinde analiz edilmesidir. Kırşehir Aybar Nakliyat, ekspertiz sonrasında fiyat teklifini yazılı olarak garantiler."
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-4">
            ...
            <p className="text-charcoal text-sm md:text-base leading-relaxed">Kırşehir Aybar Nakliyat, Yerinde keşif imkanı bulunmayan durumlarda, WhatsApp veya benzeri kanallar üzerinden görüntülü ekspertiz hizmeti vermekteyiz. Odalarınızı, gardırop içlerini ve binanızın dış cephe cephesini görüntülü arama ile ekiplerimize göstererek kısa sürede yazılı fiyat teklifi alabilirsiniz.</p>
          </div>
