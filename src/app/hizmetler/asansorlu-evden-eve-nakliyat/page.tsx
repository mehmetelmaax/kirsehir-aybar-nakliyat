...
export const metadata: Metadata = {
  title: 'Kırşehir Asansörlü Ev Taşıma',
  description: `Kırşehir'de yüksek katlı daireler için ${FACTS.maxFloor}. kata kadar ulaşan mobil dış cephe eşya asansörü kiralama ve güvenli asansörlü evden eve nakliye hizmeti.`,
  alternates: {
...
export default function AsansorluPage() {
  const sss = [
    ...
    },
    {
      ...
      "answer": `Aybar Nakliyat olarak 1. kattan başlayarak maksimum ${FACTS.maxFloor}. kata kadar ulaşan mobil dış cephe eşya asansörleriyle hizmet vermekteyiz.`
    }
  ];
  ...
  return (
    <>
      ...
      <main className="pt-24 bg-off-white">
        <Breadcrumb items={[{ name: 'Aybar Hizmetleri', url: '/#hizmetlerimiz' }, { name: 'Asansörlü Nakliyat', url: '/hizmetler/asansorlu-evden-eve-nakliyat' }]} className="pt-4" />
        ...
        <section className="py-20 bg-navy text-white text-center space-y-4">
          ...
          <p className="text-gray-300 text-sm md:text-base max-w-xl mx-auto leading-relaxed">
            Merkez ve Kaman ilçelerindeki yüksek katlı binalar için tasarlanan dış cephe mobil taşıma asansör sistemimiz.
          </p>
        </section>
        ...
        <section className="py-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="bg-brand-accent/5 p-6 rounded-xl border-l-4 border-brand-accent space-y-2 shadow-sm">
            ...
            <p className="text-brand-dark text-sm leading-relaxed font-semibold">
              "Kırşehir'de asansörlü evden eve nakliyat, mobil dış cephe asansörüyle 15. kata kadar yapılan taşıma hizmetidir. Kırşehir Aybar Nakliyat bu hizmeti sabit fiyat garantisiyle sunar; 3+1 bir daire için ortalama süre 6-8 saattir."
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-4">
            ...
            <p className="text-charcoal text-sm md:text-base leading-relaxed">
              Kırşehir Aybar Nakliyat asansörlü taşıma platformları, eşyaların bina merdiven boşluklarında darbe almasını, çizilmesini ve kırılmasını engellemektedir. Ayrıca, apartman sakinlerini rahatsız etmeden taşınma süresini ortalama yüzde 40 oranında kısaltarak zamandan tasarruf sağlar.
            </p>
          </div>
