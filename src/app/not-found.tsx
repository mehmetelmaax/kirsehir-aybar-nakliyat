...
export const metadata: Metadata = {
  title: 'Sayfa Bulunamadı | Aybar Nakliyat',
...
export default function NotFound() {
  ...
  const districts = [
    { name: 'Merkez Evden Eve', href: '/bolgeler/kirsehir-merkez-evden-eve-nakliyat' },
    { name: 'Kaman Evden Eve', href: '/bolgeler/kaman-evden-eve-nakliyat' },
    { name: 'Mucur Evden Eve', href: '/bolgeler/mucur-evden-eve-nakliyat' },
    { name: 'Çiçekdağı Evden Eve', href: '/bolgeler/cicekdagi-evden-eve-nakliyat' },
  ];
