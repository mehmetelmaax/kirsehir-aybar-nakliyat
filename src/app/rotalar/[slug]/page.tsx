...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: `Kırşehir ${route.city} Evden Eve Nakliyat | Aybar Nakliyat`,
    description: `Kırşehir'den ${route.city}'e sigortalı, marangozlu ve K3 belgeli şehirlerarası evden eve nakliyat. Sabit fiyat garantisiyle güvenle taşının.`,
    alternates: {
    ...
    '@graph': [
      {
        ...
        'name': `Kırşehir ${route.city} Evden Eve Nakliyat`,
        'description': `Kırşehir'den ${route.city}'e sigortalı, marangozlu ve K3 belgeli şehirlerarası evden eve nakliyat. Sabit fiyat garantisiyle güvenle taşının.`,
        'provider': {
      ...
      <main className="pt-24 bg-off-white">
        <Breadcrumb
          items={[
            ...
            { name: `Kırşehir - ${route.city}`, url: `/rotalar/${route.slug}` }
          ]}
          className="pt-4"
        />
        ...
        <section className="py-20 bg-navy text-white text-center space-y-4">
          ...
          <h1 className="font-display font-black text-3xl md:text-5xl tracking-tight leading-tight px-4">
            Kırşehir {route.city} Evden Eve Nakliyat
          </h1>
        ...
        <section className="py-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-4">
            <h2 className="font-display font-bold text-navy text-xl md:text-2xl flex items-center gap-2">
              ...
              <span>Kırşehir ve {route.city} Arası Mesafe ve Ev Taşıma Süresi Ne Kadardır?</span>
            </h2>
            <p className="text-charcoal text-sm md:text-base leading-relaxed font-semibold text-navy">
              Kırşehir ile {route.city} arası karayolu mesafesi yaklaşık {route.distanceKm} kilometredir ve ev eşyası taşımacılığında teslimat süresi ortalama {route.distanceKm > 300 ? '2' : '1'} gündür.
            </p>
            <p className="text-charcoal text-sm md:text-base leading-relaxed">
              {route.distanceText} Uzun mesafe yolculuklarında şoförlerimizin sürüş güvenliği, araçlarımızın hız limitleri ve yol kontrolleri tamamen yasal mevzuatlara uygun şekilde planlanır. Eşyaların Kırşehir'deki yüklenme saatinden itibaren varış noktasındaki boşaltma planına kadar her detay müşterilerimizle koordineli şekilde yürütülür.
            </p>
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-6">
            <h2 className="font-display font-bold text-navy text-xl md:text-2xl flex items-center gap-2">
              ...
              <span>Kırşehir ile {route.city} Arası Nakliyat Fiyatları Ne Kadardır?</span>
            </h2>
            <p className="text-charcoal text-sm md:text-base leading-relaxed">Kırşehir Aybar Nakliyat, {route.pricingText} Aşağıdaki tabloda, iki şehir arasında farklı daire tipleri için öngörülen ortalama fiyat aralıkları listelenmiştir:</p>
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-4">
            <h2 className="font-display font-bold text-navy text-xl md:text-2xl flex items-center gap-2">
              ...
              <span>Kırşehir ve {route.city} Arası Eşya Taşımacılığında Sigorta Kapsamı Neleri İçerir?</span>
            </h2>
            <p className="text-charcoal text-sm md:text-base leading-relaxed">
              {route.insuranceText} Şehirlerarası eşya taşımacılığı yasal olarak da emtia sigortası gerektiren bir süreçtir. Kırşehir Aybar Nakliyat, K3 yetki belgesinin zorunlu kıldığı tüm sigortacılık şartlarını eksiksiz yerine getirmektedir. Eşyalarınız araca yüklendiği andan itibaren sevk irsaliyesi ve sigorta poliçesiyle tam güvence altındadır.
            </p>
            <p className="text-charcoal text-sm md:text-base leading-relaxed mt-3 pt-3 border-t border-gray-light/60">
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-4">
            ...
            <p className="text-charcoal text-sm md:text-base leading-relaxed">Kırşehir Aybar Nakliyat, {route.notes} {route.tipsText} Uzun mesafe evden eve nakliye süreçlerinde adreslerin önceden netleştirilmesi ve taşınma sabahında nakliye kamyonunun yanaşacağı otopark alanının ayrılması hayati önem taşır.</p>
            <p className="text-charcoal text-sm md:text-base leading-relaxed mt-3 pt-3 border-t border-gray-light/60">
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-6">
            <h2 className="font-display font-bold text-navy text-xl md:text-2xl flex items-center gap-2">
              ...
              <span>Kırşehir ile {route.city} Arası Nakliyat Süreci Hakkında Sıkça Sorulan Sorular Nelerdir?</span>
            </h2>
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-6">
            <h3 className="font-display font-bold text-navy text-xl md:text-2xl border-b border-gray-light pb-3">
              Kırşehir {route.city} Nakliye Teklifi Alın
            </h3>
