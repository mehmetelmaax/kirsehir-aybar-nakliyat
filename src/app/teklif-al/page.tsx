...
export const metadata: Metadata = {
  title: 'Kırşehir Evden Eve Nakliyat Fiyat Hesaplama',
  description: "Kırşehir'de ev taşıma maliyetlerini ücretsiz hesaplayın. Merkez ve Kaman ilçeleri için sabit fiyat garantili asansörlü nakliye teklifi alın.",
  alternates: {
    canonical: '/teklif-al',
  },
};
...
export default function TeklifAlPage() {
  const teklifFaqs = [
    {
      question: 'Kırşehir evden eve nakliyat fiyatları ne kadar?',
      answer: 'Kırşehir evden eve nakliyat fiyatları 2026 yılı itibarıyla taşınacak odaların sayısına, asansör ihtiyacına ve Merkez merkezli taşıma mesafesine göre 12.000 TL ile 28.000 TL arasında değişmektedir.'
    },
    {
    ...
    },
    {
      ...
      answer: 'Aybar Nakliyat olarak sözleşmeli ve sabit fiyat garantili çalışmaktayız. Eşya detayları ve taşınma şartları değişmediği sürece anlaştığımız fiyat taşınma günü asla değişmez.'
    },
    {
