...
export const metadata: Metadata = {
  title: 'Lojistik İpuçları ve Blog',
  description: "Kırşehir'de ev taşırken dikkat edilmesi gerekenler, nakliye fiyatları, paketleme rehberleri ve asansörlü taşıma hakkında lojistik tavsiyeleri.",
  alternates: {
    canonical: '/blog',
  },
};
