...
export const metadata: Metadata = {
  title: 'İnteraktif Taşınma Kontrol Listesi ve Planlayıcı',
  description: "Kırşehir'de sorunsuz taşınmak için 30 günlük interaktif kontrol listesi. Adres değişikliği, internet, elektrik ve su abonelik nakil prosedürleri rehberi.",
  alternates: {
        ...
        <section className="py-16 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-6 print:page-break-before">
            ...
            <div className="space-y-6 text-sm text-charcoal">
              ...
              <div className="border-l-4 border-orange pl-4 space-y-2">
                <span className="font-bold text-navy text-base block">2. Su Aboneliği (Kırşehir ASKİ Genel Müdürlüğü)</span>
                <p className="leading-relaxed text-charcoal/90">
