...
export const metadata: Metadata = {
  title: 'Kırşehir En İyi Evden Eve Nakliyat Firmaları Seçim Rehberi',
  description: "Kırşehir'de ev taşırken korsan ve yetkisiz firmalardan korunma yolları. K3 yetki belgesi sorgulama, sigorta poliçesi doğrulama ve 12 altın kural.",
  alternates: {
    canonical: '/kirsehir-nakliyat-firmalari',
  },
};
...
export default function FirmalarRehberiPage() {
  ...
  const schemas = {
    ...
    '@graph': [
      serviceSchema({
        name: 'Kırşehir Nakliyat Firmaları Seçim Rehberi',
        description: "Kırşehir'de ev taşırken korsan ve yetkisiz firmalardan korunma yolları. K3 yetki belgesi sorgulama, sigorta poliçesi doğrulama ve 12 altın kural.",
        slug: 'kirsehir-nakliyat-firmalari',
        areaName: 'Kırşehir'
      }),
      ...
      <main id="main" className="pt-24 bg-off-white min-h-screen">
        ...
        <section className="py-20 bg-navy text-white text-center space-y-4">
          ...
          <h1 className="font-display font-black text-3xl md:text-5xl tracking-tight leading-tight px-4">
            Kırşehir Nakliyat Firmaları Seçim Rehberi
          </h1>
          <p className="text-gray-300 text-sm md:text-base max-w-2xl mx-auto leading-relaxed px-4">
            Kırşehir'de ev veya ofis taşırken korsan komisyoncu sitelerden korunma yolları, yasal K3 yetki belgesi sorgulama adımları ve güvenli firma seçim rehberi.
          </p>
        </section>
        ...
        <section className="py-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-4">
            ...
            <p className="text-charcoal text-sm md:text-base leading-relaxed">
              Ev taşımak, maddi ve manevi olarak hayatımızın en önemli aşamalarından biridir. Ancak internet arama motorlarında reklam vererek kendini "köklü nakliyat firması" olarak tanıtan, gerçekte ise tek bir kamyonu dahi olmayan komisyoncu sitelerin sayısı her geçen gün artmaktadır. Bu sahte siteler, sizden aldıkları işleri hiçbir güvenlik denetimi yapmadan vasıfsız üçüncü şahıslara komisyon karşılığı devretmektedir. Kırşehir Aybar Nakliyat olarak, tüketicilerimizin haklarını korumak ve hasarsız taşınmalarını sağlamak amacıyla bu şeffaf karşılaştırma ve denetim rehberini hazırladık. Kendi K3 yetki belgemiz altındaki 14 yılı aşkın tecrübemizle, güvenli lojistik standartlarını açıklıyoruz.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-4">
            ...
            <p className="text-charcoal text-sm md:text-base leading-relaxed">
              Birok korsan nakliyeci "biz sigortalı taşıyoruz" beyanında bulunsa da gerçekte hiçbir sigorta poliçesi düzenlememektedir. Gerçek bir eşya sigortası, taşınma gününden en az bir gün önce firmanın anlaşmalı acentesi üzerinden adınıza, taşınma kaynak ve hedef adresleriniz belirtilerek düzenlenmelidir. Sözleşme imzalanmadığında ise taşıma günü aniden fiyat artıran firmalara karşı yasal tüketici hak iddia etmeniz imkansızlaşır. Kapora dolandırıcılığı tuzağına düşmemek için kurumsal fatura bilgileri olmayan hesaplara yüksek tutarlı kaporalar göndermekten kaçınınız.
            </p>
          </div>
          ...
          <RelatedLinks currentSlug="kirsehir-nakliyat-firmalari" type="blog" title="Yararlı Bağlantılar ve Rehberler" />
