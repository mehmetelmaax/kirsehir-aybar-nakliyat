...
export const metadata: Metadata = {
  title: 'Mucur Evden Eve Nakliyat',
  description: "Mucur bölgesinde K3 belgeli kapalı kasa araçlarımızla sabit fiyatlı asansörlü ev taşıma. Profesyonel paketleme ve marangoz desteği.",
  alternates: {
    canonical: '/bolgeler/mucur-evden-eve-nakliyat',
  },
};
...
export default function MucurPage() {
  const sss = [
    ...
    },
    {
      ...
      answer: "Mucur genelinde sokaklar oldukça geniş olup asansör kurulumuna uygundur. Çok nadir durumlarda bina içi taşıma ve ekstra paketleme önlemleri almaktayız."
    }
  ];
  ...
  const schemas = {
    ...
    '@graph': [
      serviceSchema({
        name: 'Mucur Evden Eve Nakliyat',
        description: "Mucur bölgesinde K3 belgeli kapalı kasa araçlarımızla sabit fiyatlı asansörlü ev taşıma.",
        slug: 'bolgeler/mucur-evden-eve-nakliyat',
        areaName: 'Mucur'
      }),
      faqSchema(sss)
    ]
  ...
  const mahalleler = [
    'Yenice', 'Karşıyaka', 'Solaklı', 'Hamidiye', 'Fatih'
  ];
  ...
  return (
    <>
      ...
      <main className="pt-24 bg-off-white">
        <Breadcrumb items={[{ name: 'Bölgelerimiz', url: '/#ilcelerimiz' }, { name: 'Mucur', url: '/bolgeler/mucur-evden-eve-nakliyat' }]} className="pt-4" />
        ...
        <section className="py-20 bg-navy text-white text-center space-y-4">
          ...
          <h1 className="font-display font-black text-3xl md:text-5xl tracking-tight leading-tight">
            Mucur Evden Eve Nakliyat
          </h1>
          <p className="text-gray-300 text-sm md:text-base max-w-2xl mx-auto leading-relaxed px-4">
            Mucur ilçesi düzlük arazi yapısına sahip olup genellikle alçak katlı konut mimarisine sahiptir. Kırşehir Merkez'e en yakın ilçe konumunda bulunan Mucur'da, günlük seferlerimizle ev taşıma, ofis taşıma ve parça eşya nakliyesi süreçlerini sabit fiyat garantisiyle yürütüyoruz.
          </p>
        </section>
        ...
        <section className="py-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="bg-brand-accent/5 p-6 rounded-xl border-l-4 border-brand-accent space-y-2 shadow-sm">
            ...
            <p className="text-brand-dark text-sm leading-relaxed font-semibold">
              "Kırşehir Mucur evden eve nakliyat, Mucur ilçesinde çelik kasa nakliye kamyonları, mobil asansör sistemleri ve uzman kadrolarla sunulan ev taşıma hizmetidir. Kırşehir Aybar Nakliyat, Mucur'da bütçe dostu ve sigortalı nakliye sağlamaktadır."
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-4">
            <h2 className="font-display font-bold text-navy text-xl md:text-2xl flex items-center gap-2">
              ...
              <span>Mucur Bina Yapısı ve Asansör İhtiyacı Nedir?</span>
            </h2>
            <p className="text-charcoal text-sm md:text-base leading-relaxed">
              Mucur, düzlük arazi yapısı ve düzenli sokak yerleşimiyle nakliyat operasyonları açısından oldukça rahat bir ilçedir. Genellikle 3-4 katlı apartmanların yer aldığı Mucur'da, bina girişlerinin ve bahçe duvarlarının durumuna göre modüler asansör kurulumu gerçekleştirilir. Yüksek katlı yeni konut projelerinde ise eşyaların asansörle taşınması zamandan ve iş gücünden büyük tasarruf sağlar.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-6">
            <h2 className="font-display font-bold text-navy text-xl md:text-2xl flex items-center gap-2">
              ...
              <span>Mucur Evden Eve Nakliyat Fiyatları Ne Kadardır?</span>
            </h2>
            <p className="text-charcoal text-sm md:text-base leading-relaxed">
              Kırşehir Aybar Nakliyat tarafından sunulan ev taşıma maliyetleri binaların kat yüksekliklerine, asansör durumuna ve eşya hacmine göre belirlenmektedir. Mucur bölgesi için hazırladığımız tahmini fiyat tablosu şu şekildedir:
            </p>
            ...
            <p className="text-xs text-charcoal/70 italic border-l-2 border-orange pl-3">
              Not: Yukarıdaki fiyatlar Mucur içi standart taşınmalar için tahmini aralıkları belirtmektedir. En kesin ve sabit fiyat teklifi ücretsiz ekspertiz sürecimizden sonra verilmektedir.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-6">
            <h2 className="font-display font-bold text-navy text-xl md:text-2xl flex items-center gap-2">
              ...
              <span>Mucur İlçesinden Diğer Bölgelere Taşıma Güzergahları Nelerdir?</span>
            </h2>
            <p className="text-charcoal text-sm md:text-base leading-relaxed">
              Mucur merkezli filomuzla yalnızca bu ilçe içinde değil, Kırşehir'in tüm komşu ve uzak ilçelerine de K3 yetki belgeli kamyonlarımızla taşımacılık hizmeti veriyoruz. Her ilçenin mesafesi ve yol durumuna göre özel lojistik plan hazırlıyoruz. Sıkça taşıma gerçekleştirdiğimiz bölgelere aşağıdaki bağlantılardan ulaşabilirsiniz:
            </p>
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse text-sm">
                <thead>
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-6">
            <h2 className="font-display font-bold text-navy text-xl md:text-2xl flex items-center gap-2">
              ...
              <span>Mucur İlçesinde Ev Taşıma Süreci Nasıl Yürütülür?</span>
            </h2>
            <p className="text-charcoal text-sm md:text-base leading-relaxed">
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-6">
            <h2 className="font-display font-bold text-navy text-xl md:text-2xl flex items-center gap-2">
              ...
              <span>Mucur Nakliyat Süreci Hakkında Sıkça Sorulan Sorular Nelerdir?</span>
            </h2>
            <div className="space-y-4">
              {sss.map((item, idx) => (
