...
export const metadata: Metadata = {
  title: 'Kaman Evden Eve Nakliyat',
  description: "Kaman bölgesinde K3 belgeli kapalı kasa araçlarımızla sabit fiyatlı asansörlü ev taşıma. Profesyonel paketleme ve marangoz desteği.",
  alternates: {
    canonical: '/bolgeler/kaman-evden-eve-nakliyat',
  },
};
...
export default function KamanPage() {
  ...
  const schemas = {
    ...
    '@graph': [
      serviceSchema({
        name: 'Kaman Evden Eve Nakliyat',
        description: "Kaman bölgesinde K3 belgeli kapalı kasa araçlarımızla sabit fiyatlı asansörlü ev taşıma.",
        slug: 'bolgeler/kaman-evden-eve-nakliyat',
        areaName: 'Kaman'
      }),
      faqSchema(sss)
    ]
  ...
  const mahalleler = [
    'Sarıuşak', 'Cuma', 'Yeni', 'Çiftlikli', 'Darıözü', 'Bahçelievler'
  ];
  ...
  return (
    <>
      ...
      <main id="main" className="pt-24 bg-off-white">
        <Breadcrumb items={[{ name: 'Bölgelerimiz', url: '/#ilcelerimiz' }, { name: 'Kaman', url: '/bolgeler/kaman-evden-eve-nakliyat' }]} className="pt-4" />
        ...
        <section className="py-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="bg-brand-accent/5 p-6 rounded-xl border-l-4 border-brand-accent space-y-2 shadow-sm">
            ...
            <p className="text-brand-dark text-sm leading-relaxed font-semibold">
              "Kırşehir Kaman evden eve nakliyat, Kaman ilçesindeki çok katlı binalarda asansörlü ve sigortalı olarak yürütülen marangozlu eşya taşıma hizmetidir. Kırşehir Aybar Nakliyat, Kaman bölgesinde sabit fiyat garantisiyle taşımacılık yapmaktadır."
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-6">
            <h2 className="font-display font-bold text-navy text-xl md:text-2xl flex items-center gap-2">
              ...
              <span>Kaman Evden Eve Nakliyat Fiyatları Ne Kadardır?</span>
            </h2>
            <p className="text-charcoal text-sm md:text-base leading-relaxed">
              Kırşehir Aybar Nakliyat tarafından sunulan ev taşıma maliyetleri binaların kat yüksekliklerine, asansör durumuna ve eşya hacmine göre belirlenmektedir. Kaman bölgesi için hazırladığımız tahmini fiyat tablosu şu şekildedir:
            </p>
            ...
            <p className="text-xs text-charcoal/70 italic border-l-2 border-orange pl-3">
              Not: Yukarıdaki fiyatlar Kaman içi standart taşınmalar için tahmini aralıkları belirtmektedir. En kesin ve sabit fiyat teklifi ücretsiz ekspertiz sürecimizden sonra verilmektedir.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-6">
            <h2 className="font-display font-bold text-navy text-xl md:text-2xl flex items-center gap-2">
              ...
              <span>Kaman İlçesinden Diğer Bölgelere Taşıma Güzergahları Nelerdir?</span>
            </h2>
            <p className="text-charcoal text-sm md:text-base leading-relaxed">
              Kaman merkezli filomuzla yalnızca bu ilçe içinde değil, Kırşehir'in tüm komşu ve uzak ilçelerine de K3 yetki belgeli kamyonlarımızla taşımacılık hizmeti veriyoruz. Her ilçenin mesafesi ve yol durumuna göre özel lojistik plan hazırlıyoruz. Sıkça taşıma gerçekleştirdiğimiz bölgelere aşağıdaki bağlantılardan ulaşabilirsiniz:
            </p>
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse text-sm">
                <thead>
                ...
                <tbody className="divide-y divide-gray-light text-charcoal">
                  ...
                  <tr className="hover:bg-off-white/50">
                    <td className="p-3 font-semibold">Kaman - Akpınar Nakliyat</td>
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-6">
            <h2 className="font-display font-bold text-navy text-xl md:text-2xl flex items-center gap-2">
              ...
              <span>Kaman İlçesinde Ev Taşıma Süreci Nasıl Yürütülür?</span>
            </h2>
            <p className="text-charcoal text-sm md:text-base leading-relaxed">
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-6">
            <h2 className="font-display font-bold text-navy text-xl md:text-2xl flex items-center gap-2">
              ...
              <span>Kaman Nakliyat Süreci Hakkında Sıkça Sorulan Sorular Nelerdir?</span>
            </h2>
            <div className="space-y-4">
              {sss.map((item, idx) => (
