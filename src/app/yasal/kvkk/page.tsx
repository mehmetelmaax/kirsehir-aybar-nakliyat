    ...
    <main id="main" className="min-h-screen bg-off-white text-charcoal py-24 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-3xl mx-auto bg-white p-8 border border-gray-light rounded-xl shadow-sm space-y-6">
        ...
        <div className="space-y-4 text-sm text-charcoal">
          ...
          <p className="leading-relaxed">
            Eşyalarınızın güvenli nakledilmesi amacıyla yapılan zorunlu sigorta poliçesi düzenleme işlemleri (Anadolu Sigorta vb.) hariç, verileriniz üçüncü şahıslarla reklam veya pazarlama amacıyla paylaşılmamakta ve satılmamaktadır. Sitedeki teklif formu gönderimleri ve WhatsApp iletişimleriniz, veri iletim kanalı olarak WhatsApp (Meta) altyapısı üzerinden şifreli olarak gerçekleştirilmektedir.
          </p>
