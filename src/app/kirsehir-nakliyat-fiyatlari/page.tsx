...
export const metadata: Metadata = {
  title: 'Kırşehir Evden Eve Nakliyat Fiyatları 2026',
  description: "Kırşehir'de ev taşıma maliyetlerini ücretsiz hesaplayın. Merkez, Kaman, Mucur oda sayıları ve kat durumlarına göre güncel asansörlü nakliye fiyat listesi.",
  alternates: {
    canonical: '/kirsehir-nakliyat-fiyatlari',
  },
};
...
export default function FiyatlarPage() {
  const pricingFaqs = [
    {
      question: "Kırşehir'de oda sayısına göre ev taşıma fiyatları nasıl değişir?",
      answer: "Kırşehir Aybar Nakliyat bünyesinde oda sayısı arttıkça taşınacak eşya hacmi, kullanılacak koruyucu ambalaj malzemesi miktarı ve çalışacak uzman personel sayısı artar. Örneğin, 1+1 dairelerin nakliyesi ortalama 3 personel gerektirirken, 3+1 veya 4+1 daireler marangoz dahil en az 5-6 kişilik bir nakliye ekibi gerektirdiğinden maliyeti doğrudan etkiler."
    },
    {
    ...
    },
    {
      ...
      answer: "Evet, Kırşehir Aybar Nakliyat tarafından sunulan tüm standart ev taşıma fiyatlarına gardırop, yatak odası üniteleri, TV üniteleri de-montaj ve montaj işlemleri ile çamaşır ve bulaşık makinesi bağlantıları dahildir. Ekstra marangoz montaj işçilik farkı kesinlikle talep edilmez."
    },
    {
      question: "Kırşehir ilçeler arası nakliyat fiyatları mesafeye göre nasıl hesaplanır?",
      answer: "Merkez çıkışlı ana garajımızdan sevk edilen araçların Kaman, Mucur, Çiçekdağı veya Akpınar gibi çevre ilçelere olan uzaklıkları gidiş-dönüş kilometre hesabı yapılarak akaryakıt giderleri üzerinden tablolandırılır. Mesafe uzadıkça yol yevmiyeleri ve yakıt maliyeti toplam fiyata eklenmektedir."
    },
    {
      question: "Sigortalı evden eve taşımacılık ekstra ücrete tabi midir?",
      answer: "Hayır. Kırşehir Aybar Nakliyat olarak yürüttüğümüz her nakliye faaliyeti, eşyalarınızın yoldaki kaza, yangın, devrilme gibi hasar risklerine karşı ücretsiz emtia taşıma sigortası kapsamına alınarak gerçekleştirilir. Sigorta poliçesi taşınma öncesinde adınıza düzenlenmektedir."
    },
    {
    ...
    },
    {
      ...
      answer: "Şehirlerarası nakliye fiyat tekliflerimizde tüm otoban geçiş, otoyol, köprü ve feribot ücretleri Kırşehir Aybar Nakliyat’a aittir. Müşterilerimize sonradan yol masrafı adı altında herhangi bir ek gider yansıtılmamaktadır."
    },
    {
  ...
  const schemas = {
    ...
    '@graph': [
      serviceSchema({
        name: 'Kırşehir Evden Eve Nakliyat Fiyatları',
        description: "Kırşehir'de ev taşıma maliyetlerini ücretsiz hesaplayın. Merkez, Kaman, Mucur oda sayıları ve kat durumlarına göre güncel asansörlü nakliye fiyat listesi.",
        slug: 'kirsehir-nakliyat-fiyatlari',
        areaName: 'Kırşehir'
      }),
      faqSchema(pricingFaqs),
      {
        ...
        'url': SITE.url + '/kirsehir-nakliyat-fiyatlari'
      }
    ]
  };

  const rotalarListesi = [
    { hat: 'Kırşehir - Ankara', km: '185 km', fiyat: '20.000 TL - 25.000 TL' },
    { hat: 'Kırşehir - İstanbul', km: '630 km', fiyat: '20.000 TL - 25.000 TL' },
    { hat: 'Kırşehir - Kayseri', km: '135 km', fiyat: '20.000 TL - 25.000 TL' },
    { hat: 'Kırşehir - Kırıkkale', km: '110 km', fiyat: '20.000 TL - 25.000 TL' },
    { hat: 'Kırşehir - Yozgat', km: '110 km', fiyat: '20.000 TL - 25.000 TL' },
    { hat: 'Kırşehir - Nevşehir', km: '90 km', fiyat: '20.000 TL - 25.000 TL' },
    { hat: 'Kırşehir - Aksaray', km: '110 km', fiyat: '20.000 TL - 25.000 TL' },
    { hat: 'Kırşehir - İzmir', km: '730 km', fiyat: '20.000 TL - 25.000 TL' },
  ];
      ...
      <main id="main" className="pt-24 bg-off-white min-h-screen">
        ...
        <section className="py-20 bg-navy text-white text-center space-y-4">
          ...
          <h1 className="font-display font-black text-3xl md:text-5xl tracking-tight leading-tight px-4">
            Kırşehir Evden Eve Nakliyat Fiyatları
          </h1>
          <p className="text-gray-300 text-sm md:text-base max-w-2xl mx-auto leading-relaxed px-4">
            Kırşehir genelinde ev taşıma maliyetlerini belirleyen tüm operasyonel etkenler ve güncel bütçe tarifeleri bu sayfada listelenmektedir. Kırşehir Aybar Nakliyat olarak, tüm taşınma bütçelerinizi şeffaf bir şekilde analiz etmeniz için interaktif hesaplama robotumuzu sunuyoruz.
          </p>
        </section>
        ...
        <section className="py-12 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-4 text-center mb-8">
            ...
            <p className="text-charcoal text-sm max-w-xl mx-auto">
              Kırşehir Aybar Nakliyat maliyet hesaplayıcı robotumuz, dairenizin oda durumunu ve asansör gereksinimlerini analiz ederek tahmini bütçeyi anında çıkartır.
            </p>
          </div>
          <PriceCalculator />
        </section>

        {/* Section 1: Kırşehir'de Ev Taşıma Ne Kadar Tutar? */}
        <section className="py-12 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-4">
            <h2 className="font-display font-bold text-navy text-xl md:text-2xl">
              Kırşehir'de Ev Taşıma Ne Kadar Tutar?
            </h2>
            <p className="text-charcoal text-sm md:text-base leading-relaxed">
              Kırşehir'de ev taşıma maliyetleri 2026 yılı itibarıyla oda sayısına, asansör durumuna ve mesafeye bağlı olarak ortalama ₺20.000 ile ₺25.000 arasında değişmektedir. Eşyaların hacmi, taşınacak katların yükseklikleri, ambalajlama ve paketleme kalitesi ile marangozluk işçiliği bu bütçe aralığını doğrudan belirleyen temel bileşenlerdir.
            </p>
            <p className="text-charcoal text-sm md:text-base leading-relaxed">
        ...
        <section className="py-12 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-6">
            ...
            <p className="text-charcoal text-sm md:text-base leading-relaxed">Kırşehir Aybar Nakliyat, Evden eve nakliye tekliflerinde yer alan bütçe aralıkları, sekiz ana lojistik kalemin birleşiminden meydana gelmektedir. Bu etkenler, her müşterinin taşınma şartlarına göre ayrı ayrı hesaplanır:</p>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-charcoal text-sm leading-relaxed">
                  Yüksek katlı konutlarda bina yönetimleri bina içi asansörle taşımayı yasakladığı için dış cephe mobil eşya asansörü kurulması operasyonel bir zorunluluktur. Kurulacak asansör sayısı (sadece yüklemede veya hem yükleme hem teslimatta) fiyata yansır.
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <p className="text-charcoal text-sm leading-relaxed">
                  Yükleme noktası ile teslimat adresi arasındaki kilometre farkı, kamyon veya tırlarımızın yakıt tüketimini ve amortisman giderlerini belirler. Kırşehir şehiriçi, çevre ilçeler ve şehirlerarası taşımalarda km katsayıları farklıdır.
                </p>
              </div>
        ...
        <section className="py-12 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-4">
            ...
            <p className="text-charcoal text-sm md:text-base leading-relaxed">
              Kırşehir Aybar Nakliyat tarafından kullanılan dış cephe mobil teleskopik eşya asansörleri, yüksek katlı binalardaki eşyaların bina içi merdivenlere sokulmadan pencere veya balkondan nakliye aracına transfer edilmesini sağlayan teleskopik platform sistemidir. Aybar Nakliyat asansör filosu bünyesindeki araçların tek taraflı kurulum maliyeti 2.500 TL olarak yansıtılmaktadır. Hem yükleme yerinde hem de teslimat yerinde asansör kurulması gerekirse asansör maliyeti 5.000 TL olarak fiyata yansır. Binada yük asansörü olması ve site yönetiminin buna izin vermesi durumunda bu ücretten tasarruf sağlanmaktadır.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-4">
            ...
            <p className="text-charcoal text-sm md:text-base leading-relaxed">
              Şehirlerarası ev taşıma fiyatları, Merkez ana garajımızdan çıkış yapacak aracın gideceği hedef şehir arasındaki kilometre bazlı mesafe hesabı yapılarak belirlenmektedir. Hesaplama formülü şu şekildedir:
            </p>
            ...
            <p className="text-charcoal text-sm md:text-base leading-relaxed">
              Kırşehir Aybar Nakliyat tarafından sıkça taşıma yapılan bazı şehirlerarası hatlar ve tahmini taşıma fiyatları tablosu:
            </p>
              ...
              <table className="w-full text-left border-collapse text-sm">
                <thead>
                  <tr className="bg-navy text-white">
                    <th className="p-3 font-display rounded-tl-lg">Hat Güzergahı</th>
                ...
                <tbody className="divide-y divide-gray-light text-charcoal">
                  {rotalarListesi.map((rot, idx) => (
                    <tr key={idx} className="hover:bg-off-white/50">
                      <td className="p-3 font-semibold">{rot.hat} Nakliyat</td>
                      <td className="p-3">{rot.km}</td>
                      <td className="p-3 font-bold text-orange-text">{rot.fiyat}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
          ...
          <RelatedLinks currentSlug="kirsehir-nakliyat-fiyatlari" type="blog" title="Yararlı Bağlantılar ve Rehberler" />
        </section>
      </main>
    </>
  );
