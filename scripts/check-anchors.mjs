...
const ignoredGlobalAnchors = [
  ...
  'kvkk açık rıza metnini', 'kvkk acik riza metnini',
  ...
  'kırşehir evden eve nakliyat fiyatları nasıl belirlenir yazımız', 'kirsehir evden eve nakliyat fiyatlari nasil belirlenir yazimiz',
  'ücretsiz ekspertiz', 'ucretsiz ekspertiz',
  'kaman profesyonel taşımacılık', 'kaman profesyonel tasimacilik',
  ...
  'mucur uygun fiyatlı nakliyat', 'mucur uygun fiyatli nakliyat',
  'mucur asansörlü ev taşıma', 'mucur asansorlu ev tasima',
  'kırşehir şehirlerarası evden eve nakliyat çözümleri', 'kirsehir sehirlerarasi evden eve nakliyat cozumleri',
  'kırşehir nakliyat fiyatları', 'kirsehir nakliyat fiyatlari',
  'kırşehir evden eve nakliyat fiyatları nasıl belirlenir detaylı incelemesi', 'kirsehir evden eve nakliyat fiyatlari nasil belirlenir detayli incelemesi',
  'kaman evden eve nakliyat', 'kaman evden eve nakliyat',
  'asansörlü nakliyat', 'asansorlu nakliyat',
  'kırşehir merkez evden eve nakliyat', 'kirsehir merkez evden eve nakliyat',
  'mucur evden eve nakliyat', 'mucur evden eve nakliyat',
  'çiçekdağı evden eve nakliyat', 'cicekdagi evden eve nakliyat',
  'akpınar evden eve nakliyat', 'akpinar evden eve nakliyat',
  'boztepe evden eve nakliyat', 'boztepe evden eve nakliyat',
  'akçakent evden eve nakliyat', 'akcakent evden eve nakliyat',
