...
function runWordCount() {
  ...
  for (const file of htmlFiles) {
    ...
    const legacyRoutes = [
      '/bolgeler/akpinar-evden-eve-nakliyat',
      '/bolgeler/boztepe-evden-eve-nakliyat',
      '/bolgeler/akcakent-evden-eve-nakliyat',
      ...
      '/blog/kirsehir-nakliyat-fiyatlari',
      '/blog/kirsehir-semt-rehberi',
      '/blog/asansorlu-tasima-avantajlari',
      '/blog/esya-paketleme-rehberi',
      '/blog/asansorlu-nakliyat-mi-merdivenle-mi',
      '/blog/beyaz-esya-tasima-rehberi',
      '/blog/k3-yetki-belgesi-nedir',
      '/blog/kapora-tuzagi-ucuz-nakliyat',
      '/blog/kirsehirda-tasinmak-icin-en-uygun-zaman',
      '/blog/ofis-tasima-plani',
      '/blog/sehirlerarasi-tasimada-esya-hasari',
      '/blog/tasinirken-yapilan-yasal-hatalar'
    ];
